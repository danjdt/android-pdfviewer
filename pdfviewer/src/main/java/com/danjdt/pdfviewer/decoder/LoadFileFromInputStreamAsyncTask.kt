 ...
 */
class LoadFileFromInputStreamAsyncTask(private val outFile: File, private val listener: OnLoadFileListener, private val input: InputStream) : CoroutinesAsyncTask<Void, Void, Void>() {
