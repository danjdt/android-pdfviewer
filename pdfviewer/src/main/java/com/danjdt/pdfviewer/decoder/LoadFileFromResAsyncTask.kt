 ...
 */
class LoadFileFromResAsyncTask(private val outFile: File, private val listener: OnLoadFileListener, private val input: InputStream) : AsyncTask<Void, Void, Void>() {
